...
.. module:: inputOM
   :platform: Windows
   :synopsis: Input module to DTOcean WP6
   
.. moduleauthor:: moduleauthor:: Bahram Panahandeh <bahram.panahandeh@iwes.fraunhofer.de>
"""
...
class inputOM:
    ...
    #------------------------------------------------------------------------------  
    #------------------------------------------------------------------------------
    #------------------ WP6 input data class
    #------------------------------------------------------------------------------
    #------------------------------------------------------------------------------
    inputOM: The class contains all the datas required in WP6 moduel.
    ...
    Args:
        ...
        keys:
            ...
            wage_specialist_day (float) [€/h]       : Wage for specialists crew at daytime e.g. diver
            wage_specialist_night (float) [€/h]     : Wage for specialists crew at night time e.g. diver
            wage_technician_day (float) [€/h]       : Wage for technicians at daytime
            wage_technician_night (float) [€/h]     : Wage for technicians at night time                
    ...
    def get_Farm_OM(self):
        ...
        Returns:
            Farm_OM (dict) : Farm_OM (dict): This parameter records the O&M general information for the farm as whole        
        '''                                   
    ...
    def get_Inspection(self):
        ...
        Returns:
	    Inspection (Pandas DataFrame): This table stores information related to the inspections required for each failure modes
                                         Please note that each defined inspection will be a column in Pandas DataFrame table “Inspection”:
        '''                                   
    ...
    def get_Simu_Param(self):
        ...
        Returns:
	    Simu_Param (dict): This parameter records the information of simulation
        '''                                   
    ...
    def get_Control_Param(self):
        ...
        Returns:
	    Control_Param (dict): This parameter records the O&M module control from GUI
        '''                                   
    ...
    def checkInput(self):
        ...
        """
        checkInput: used to assess the validity of the input given to the WP6 prior to perform any calculation
